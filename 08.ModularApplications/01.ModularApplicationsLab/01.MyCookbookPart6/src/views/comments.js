...
import { getCommentsByRecipeId, createComment, delComment } from '../api/data.js';
...
function comment(data) {
    const temp = html`
<li class="comment">
    <header>${data.author.username}</header>
    <p>${data.content}</p>
...
function createForm(formActive, toggleForm, onSubmit) {
    ...
    if (userId == null) {
        ...
        return commentFormTemplate(formActive, toggleForm, onSubmit, userId);
    }
}